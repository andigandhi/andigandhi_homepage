...
function addWindow(title, icon, innerHtml, w, h, left, top) {
	...
	taskbar_item.innerHTML = '<img alt="" src="/img/ico/'+icon+'" style="height: 19px; margin-right: 5px; margin-top:-4px; float:left;">'
...
function maximizeWindow(window_id) {
	...
	window_div.getElementsByClassName("window-body")[0].style.height = window_div.clientHeight - 35 + "px"
}
...
function build_menu() {	
	...
	menu_div.innerHTML = '<img alt="" src="/img/index/andigandhi98.png" style="width: 150px; margin-top: 5px;">'
